<p align="center"><img src="resources/robot.svg" width="25px" height="25px"><h1 align="center"> Astroy</h1></p>
...
I made this as a tool without distribution in mind, and did not think I would come to open-source it. As a result, a LOT of assumptions have been made when coding this, and it's gonna take you a bit of tweaking if the OS you're running isn't configured how the tool needs it to be. Shouldn't be too hard, though.
